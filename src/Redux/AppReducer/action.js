...
const getTasks = () => (dispatch) => {
  ...
  return axios
    .get("https://react-todo-appbackend.herokuapp.com/tasks")
    .then((r) => {
...
const getTagsList = () => (dispatch) => {
  ...
  return axios
    .get("https://react-todo-appbackend.herokuapp.com/tagList")
    .then((r) => {
...
const updateSubtasksList = (id, payload) => (dispatch) => {
  ...
  return axios
    .patch(`https://react-todo-appbackend.herokuapp.com/tasks/${id}`, payload, {
      headers: {
...
const addTag = (tag) => (dispatch) => {
  ...
  return axios
    .post("https://react-todo-appbackend.herokuapp.com/tagList", { tag })
    .then((r) => {
...
const createTask = (payload) => (dispatch) => {
  ...
  return axios
    .post("https://react-todo-appbackend.herokuapp.com/tasks", payload)
    .then((r) => {
